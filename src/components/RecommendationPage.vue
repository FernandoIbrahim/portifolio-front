<template>
    <div class="w-full flex flex-col items-center">
        <AtacarejoComponent  title = "Atacarejo Fernando" job=""  :img = "`/vale.png`" desc = "Acredito que o estágio será extremamente benéfico para a aplicação futura dos conhecimentos adquiridos, tanto na gestão de suprimentos do meu comércio local familiar quanto no meu desenvolvimento de aplicações práticas, eficientes, escaláveis e extensíveis para a análise de dados nesse contexto." />
