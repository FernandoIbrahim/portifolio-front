<template>
    <div class="w-full flex flex-col items-center">
        ...
        <ProjectComponent name = "ArcelorMittal Sistemas" desc = "Estágio em Gerenciamento de Projetos de TI, com atuação em atividades como levantamento de requisitos, elaboração de quadros Kanban e matrizes de riscos, além do planejamento do backlog e das sprints dos projetos" :img = "`/arcelormittal.jpg`" data = "2024" url="/"
